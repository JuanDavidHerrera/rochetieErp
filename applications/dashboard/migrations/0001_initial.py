    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('legal_name', models.CharField(blank=True, max_length=80, null=True, verbose_name='Nombre legal')),
                ('nit', models.CharField(blank=True, max_length=13, null=True, verbose_name='NIT')),
                ('address', models.CharField(max_length=120, verbose_name='Dirección')),
                ('address_2', models.CharField(max_length=120, verbose_name='Datos adicionales')),
                ('validation_date', models.DateField(blank=True, null=True, verbose_name='Fecha de creación')),
                ...
                ('city', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='cities_light.city', verbose_name='Ciudad')),
